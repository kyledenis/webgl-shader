...
<template>
  <div class="home-page">
    ...
    <div id="overlay" :class="{ 'fade-out': isFadingOut }"></div>
    <button id="enterButton" @click="enterKHole">Enter the K-Hole</button>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    setFavicon() {
      ...
      img.src = require('@/assets/hazzyCat.png');
    },
    enterKHole() {
      this.isFadingOut = true;
      setTimeout(() => {
        this.$router.push('/khole');
      }, 1500);
    }
  }
}
